...
class CallPE(SVFStmt):
    ...
    def getOpCallICFGNode(self, idx: int) -> "CallICFGNode": ...
    """Get the call ICFG node for one operand"""
...
class BaseObjVar(ObjVar):
    ...
    def getConstantInitializerBytes(self) -> List[int]: ...
    """Return byte values from a constant global initializer when available"""
...
class AbstractState:
    ...
    def initObjVar(self, obj_var: ObjVar) -> None: ...
...
class AbstractInterpretation:
    ...
    def hasAbsState(self, node: ICFGNode) -> bool: ...
    def joinStates(self, dst: AbstractState, src: AbstractState) -> None: ...
    def getAbsValue(self, var: SVFVar, node: ICFGNode) -> AbstractValue: ...
    def hasAbsValue(self, var: SVFVar, node: ICFGNode) -> bool: ...
    def updateAbsValue(self, var: SVFVar, val: Union[AbstractValue, IntervalValue, AddressValue], node: ICFGNode) -> None: ...
    def getGepByteOffset(self, gep: GepStmt) -> IntervalValue: ...
    def getGepObjAddrs(self, pointer: SVFVar, offset: IntervalValue) -> AddressValue: ...
    def loadValue(self, pointer: SVFVar, node: ICFGNode) -> AbstractValue: ...
    def storeValue(self, pointer: SVFVar, val: AbstractValue, node: ICFGNode) -> None: ...
...
class AbsExtAPI:
    def __init__(self, ae: AbstractInterpretation) -> None: ...
    def handleExtAPI(self, call: CallICFGNode) -> None: ...
    def getElementSize(self, var: SVFVar) -> int: ...
    def getStrlen(self, str_value: SVFVar, node: ICFGNode) -> IntervalValue: ...
    def handleMemcpy(self, dst: SVFVar, src: SVFVar, length: IntervalValue, start_idx: int, node: ICFGNode) -> None: ...
    def handleMemset(self, dst: SVFVar, elem: IntervalValue, length: IntervalValue, node: ICFGNode) -> None: ...
    def getRangeLimitFromType(self, type: SVFType) -> IntervalValue: ...
    def getAbsState(self, node: ICFGNode) -> AbstractState: ...
    @staticmethod
    def isValidLength(length: IntervalValue) -> bool: ...
